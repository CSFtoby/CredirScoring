        ...
        private void mostrar_reporte()
        {
            ...
            try
            {
                ...
                for (int x = 0; x < dt.Rows.Count; x++)
                {
                    ...
                    var col1 = dt.Rows[x]["seccion"].ToString();
                    var col2 = dt.Rows[x]["documento_id"].ToString();
                    var col3 = dt.Rows[x]["descripcion"].ToString();
                    var col4 = dt.Rows[x]["tipo_exigencia"].ToString();
                    var col5 = dt.Rows[x]["adjunto"].ToString();
                    dtData.Rows.Add(col0, col1, col2, col3, col4, col4, img1);
                }
                #endregion
                ...
                ReportParameter pa12 = new ReportParameter("pa_tipo_persona", dt2.Rows[0]["tipo_persona"].ToString());
                ReportParameter pa13 = new ReportParameter("pa_fuente", dt2.Rows[0]["DESCRIPCION_FUENTE"].ToString());
                ...
                this.reportViewer1.LocalReport.SetParameters(pa12);
                this.reportViewer1.LocalReport.SetParameters(pa13);
