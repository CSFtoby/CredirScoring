...
namespace wfcModel
{
	public class DataAccess
	{
        ...
        //Toby--> llenado de la tabla de miembros
        public DataTable Llenar_Miembros(Int32 p_miembro_id)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"select A.NOMBRE, A.IDENTIDAD, B.TIPO_MIEMBRO AS MIEMBRO, C.DESCRIPCION AS ZONA from WFC.DCS_MIEMBROS A
                                INNER JOIN WFC.DCS_WF_TIPO_MIEMBRO B
                                ON A.ID_TIPO_MIEMBRO = B.ID_MIEMBRO
                    ...
                    try
                    {
                        da.SelectCommand.Parameters.Add("pa_carpeta_id", p_miembro_id);
                        da.Fill(dt);
                    }
                    catch (Exception e)
                    {
        ...
        //Toby--> Realizar busqueda
        public DataTable buscar_Miembros(Int32 p_miembro_id)
        {
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"select A.NOMBRE, A.IDENTIDAD, A.COD_CLIENTE, B.TIPO_MIEMBRO AS MIEMBRO, C.DESCRIPCION AS ZONA, A.ACTIVO
                                ...
                                INNER JOIN cef_zonas C
                                ON A.CODIGO_ZONA = C.CODIGO_ZONA
                                where A.COD_CLIENTE = pa_miembro_id";
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"Select s.no_solicitud,nombres||' '||primer_apellido nombre,desc_sub_aplicacion,s2.monto_solicitado,tasa,plazo,meses_plazo,no_movimiento_actual,banderin_id,estado_solicitud_id,
                                          oficial_servicio,codigo_agencia_origen,estacion_id,recalculos_permitidos,recalculos_actuales, s.FECHA_APROBACION_RECHAZO
                                 From dcs_solicitudes s,
                                      dcs_solicitudes2 s2,
                                      mgi_clientes c,
                                      mgi_sub_aplicaciones sa 
        ...
        //Toby---> obtener usuarios que aprobaron 
        public DataTable ObtenerApr(Int32 p_no_solicitud)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"Select s2.USUARIO_ING
                                    From dcs_solicitudes s,
                                         WFC.DCS_WF_EVENTLOG s2
                                    Where s.no_solicitud=s2.no_solicitud  
                                         AND s2.VALOR_NUEVO = '2'
                                     AND s.no_solicitud=:pa_no_solicitud";
		...
		//trae las estaciones para usuario
        ...
        //combobox excepciones 
        public DataTable ObtenerExcepxUsuario(int zona)
        {
            string sql;
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    switch (zona) {
                        case 0:
                            sql = "select  estacion_id, nombre "+
                                    "from DCS_wf_estaciones "+
                                    "where ESTACION_ID in (2003,2001,1006,1001)";
                            da = new OracleDataAdapter(sql, ConexionOracle);
                            try
                            {
                                da.Fill(dt);
                            }
                        ...
                        case 1:
                            sql = "select  estacion_id, nombre " +
                                    "from DCS_wf_estaciones " +
                                    "where ESTACION_ID in (3003,3001,1006,1001)";
                            da = new OracleDataAdapter(sql, ConexionOracle);
                            try
                            {
                                da.Fill(dt);
                        ...
                        case 2:
                            sql = "select  estacion_id, nombre " +
                                    "from DCS_wf_estaciones " +
                                    "where ESTACION_ID in (1004,1002,1006,1001)";
                            da = new OracleDataAdapter(sql, ConexionOracle);
                            try
                            {
                                da.Fill(dt);
        ...
        //Combo de Zonas
        public DataTable ObtenerZonasExcp()
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT COD_ZONA, DESCRIPCION
                                    FROM EXCP.DCS_EXC_ZONA";
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    try
                    {
                        //da.SelectCommand.Parameters.Add("pa_usuario", p_usuario);
        ...
        //metodo para obtener el tipo de miembro en una solicitud mediante la id
        public DataTable ObtenerTipoMiembroXID(string p_id_user) {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            ...
            try {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"select B.TIPO_MIEMBRO from wfc.dcs_miembros A
                                    INNER JOIN WFC.DCS_WF_TIPO_MIEMBRO B
                                on A.ID_TIPO_MIEMBRO = B.ID_TIPO_MIEMBRO
                                where identidad= :pa_usuario";
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    try
                    {
                        da.SelectCommand.Parameters.Add("pa_usuario", p_id_user);
                        da.Fill(dt);
                    }
                    catch (Exception e)
                    {
        ...
        //Toby--> obtener las Areas par reportes
        public DataTable ObtenerAreas()
        {
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT 0 ESTACION_ID,'Excepciones' NOMBRE FROM DUAL UNION
                                   SELECT ESTACION_ID, NOMBRE 
                                     FROM WFC.DCS_WF_ESTACIONES
                                   WHERE ESTACION_ID in (1000,3001,2001,1002,3003,2003,1004,7000,1003,2002,3002)";
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    try
                    {
                        da.Fill(dt);
        ...
        //toby---> para llenar datos de analisis del observador 
        public DataTable ObtenerSituacionActualNEWxSolicitud(Int32 p_no_solicitud)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
                ...
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"Select es.estado_id,estacion_id,attr_nueva,no_movimiento_actual,con_adjunto,plazo,tasa,
                                     ...
                                     from dcs_solicitudes s1,
                                          ...
                                          WFC.DCS_WF_DESTINOS_CREDITO de,
                                          dcs_wf_fuentes_financiamiento f,
                                          MGI.MGI_AGENCIAS m
                                    Where s1.no_solicitud=s2.no_solicitud
                                      and s1.estado_solicitud_id=es.estado_id
                                      and s2.DESTINO = de.DESTINO_ID
                                      and s1.codigo_fuente=f.codigo_fuente(+)
                                      and s1.CODIGO_AGENCIA_ORIGEN = m.CODIGO_AGENCIA
        ...
        public int ExisteRevivion(Int32 p_no_solicitud) {
            Int32 resp = 0;
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT COUNT(*) TOTAL
                                    FROM WFC.DCS_SOLICITUDES_APROBACIONES
                    ...
                    {
                        dr.Read();
                        resp = Convert.ToInt32(dr["TOTAL"].ToString());
                    }
                    dr.Close();
                    cmd.Dispose();
                }
		...
		{
			DataTable dt = new DataTable();
            int total_valores = ExisteRevivion(p_no_solicitud);
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
                    if (total_valores > 0)
                    {
                        sql = @"Select es.estado_id,
                                estacion_id,
                                attr_nueva,
                                s1.no_movimiento_actual,
                                con_adjunto,
                                plazo,tasa,
                                monto_aprobado,plazo_aprobado,tasa_aprobada,
                                no_acta_resolucion,
                            ...
                            from dcs_solicitudes s1,
                                dcs_solicitudes2 s2,
                                dcs_wf_estado_solicitudes es,
                                wfc.dcs_solicitudes_aprobaciones ap
                        Where s1.no_solicitud=s2.no_solicitud
                            and s1.estado_solicitud_id=es.estado_id
                            and s1.no_solicitud = ap.NO_SOLICITUD
                            and s1.no_solicitud=:pa_no_solicitud
                            order by ap.FECHA_DECISION DESC";
                    }
                    else {
                        sql = @"Select es.estado_id,estacion_id,attr_nueva,no_movimiento_actual,con_adjunto,plazo,tasa,
                                    monto_aprobado,plazo_aprobado,tasa_aprobada,
                                    no_acta_resolucion,
                                    ciudad_resolucion,
                                    s1.estado_solicitud_id,
        ...
        //Toby--> obtener las Areas par reportes
        public DataTable ObtenerMotivosRechazo()
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT COD_RECHAZO, DESCRIPCION
                                    FROM WFC.DCS_WF_COD_RECHAZO";
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    try
                    {
                        da.Fill(dt);
        ...
        //toby-->eliminar resolucion de excp por usuario  
        public bool EliminarExcepcionxUsuario(Int32 p_no_excp, string p_usuario, Int32 p_movimiento_actual, int registro)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"EXCP.EXCP_P_DELETEEXPXSER";

                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.Add("pa_no_excp", OracleType.Number).Value = p_no_excp;
                    cmd.Parameters.Add("pa_usuario", OracleType.VarChar, 30).Value = p_usuario;
                    cmd.Parameters.Add("pa_movimiento_actual", OracleType.Number).Value = p_movimiento_actual;
                    cmd.Parameters.Add("pa_registro", OracleType.Number).Value = registro;
                    ConexionOracle.Open();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.ExecuteNonQuery();
        ...
        //toby-->poner solicitud en proceso
        public bool putProcess(Int32 p_no_sol)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"UPDATE WFC.DCS_SOLICITUDES
                                    SET ESTADO_SOLICITUD_ID = 2, ABIERTA = 'S'
                                 WHERE NO_SOLICITUD = :pa_sol";

                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.Add("pa_sol", OracleType.Number).Value = p_no_sol;
        ...
        //toby-->editar Comentarios en las solicitudes
        public bool EditarComentarioxUsuarioSOL(Int32 p_no_sol, string p_usuario, Int32 p_movimiento_actual, string p_comentario)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"UPDATE WFC.DCS_SOLICITUDES_APROBACIONES
                                    SET OBSERVACIONES = :pa_observaciones
                                    WHERE NO_SOLICITUD = :pa_sol
                                    AND USUARIO_COMITE = :pa_user
                                    AND NO_MOVIMIENTO_ACTUAL = :pa_movimiento_actual";

                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.Add("pa_observaciones", OracleType.VarChar).Value = p_comentario;
                    cmd.Parameters.Add("pa_sol", OracleType.Number).Value = p_no_sol;
                    cmd.Parameters.Add("pa_user", OracleType.VarChar).Value = p_usuario;
                    cmd.Parameters.Add("pa_movimiento_actual", OracleType.Number).Value = p_movimiento_actual;
        ...
        public bool EditarTasaSOL(Int32 p_no_sol, double tasa)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"UPDATE WFC.DCS_SOLICITUDES2
                                        SET TASA = to_number(:pa_tasa)
                                    WHERE NO_SOLICITUD = :pa_sol";

                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.Add("pa_sol", OracleType.Number).Value = p_no_sol;
                    cmd.Parameters.Add("pa_tasa", OracleType.Double).Value = tasa;
        ...
        //toby-->quitar Comentarios en las solicitudes
        public bool EliminarComentarioxUsuarioSOL(Int32 p_no_sol, string p_usuario, Int32 p_movimiento_actual)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                ...
                {
                    string sql = @"UPDATE WFC.DCS_SOLICITUDES_APROBACIONES
                                    SET FECHA_DECISION = null, DECISION = null, OBSERVACIONES = '', PENDIENTE_RESPUESTA_B = 'S', COD_RECHAZO = null, RECHAZO = ''
                                    WHERE NO_SOLICITUD = :pa_sol
                                    AND USUARIO_COMITE = :pa_user
                                    AND NO_MOVIMIENTO_ACTUAL = :pa_movimiento_actual";
        ...
        //toby-->quitar Comentarios en las excepciones 
        public bool EliminarComentarioxUsuarioEXCP(Int32 p_no_excp, string p_usuario, Int32 p_movimiento_actual, int registro)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"UPDATE EXCP.DCS_EXCEPCIONES_APROBACIONES
                                    SET FECHA_DECISION = null, DECISION_ID = null, OBSERVACIONES = '', PENDIENTE_RESPUESTA_B = 'S'
                                    WHERE NO_REGISTRO_AP = :pa_registro
                                    AND CODIGO_EXCEPCION = :pa_excp
                                    AND USUARIO_COMITE = :pa_user
                                    AND NO_MOVIMIENTO_ACTUAL = :pa_movimiento_actual";
                    ...
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.Add("pa_registro", OracleType.Number).Value = registro;
                    cmd.Parameters.Add("pa_excp", OracleType.Number).Value = p_no_excp;
                    cmd.Parameters.Add("pa_user", OracleType.VarChar).Value = p_usuario;
                    cmd.Parameters.Add("pa_movimiento_actual", OracleType.Number).Value = p_movimiento_actual;
        ...
        public bool EsAdminTemporal(string pa_user)
        {
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            bool esAdmin = false;
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT COUNT(*) CUENTA
                                    FROM EXCP.DCS_EXC_TMP_ADMINWHERE USUARIO = :pa_usuario
                                    AND TO_DATE(SYSDATE) BETWEEN TO_DATE(INICA) AND TO_DATE(FINALIZA)";
                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.AddWithValue("pa_usuario", pa_user);
                    ConexionOracle.Open();
                    dr = cmd.ExecuteReader();
        ...
        //Toby--> validar si es amdin temporal
        public bool TipoAdminTemporalS(string pa_user)
        {
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            bool esAdmin = false;
        ...
        //-->valida si el administrador es temporal 
        public bool TipoAdminTemporalE(string pa_user)
        {
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            bool esAdmin = false;
        ...
        //-->valida si el administrador es temporal 
        public int ObtenerZona(string pa_user)
        {
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            int valor = 0;
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT Z.CODIGO_ZONA
                                    FROM CEF.CEF_ZONAS Z, CEF.CEF_AGENCIAS_ZONA  ZA, MGI.MGI_AGENCIAS A, MGI.MGI_USUARIOS U
                                    WHERE Z.CODIGO_ZONA = ZA.CODIGO_ZONA
                                    AND ZA.CODIGO_AGENCIA = A.CODIGO_AGENCIA
                                    AND A.CODIGO_AGENCIA = U.CODIGO_AGENCIA
                    ...
                    {
                        dr.Read();
                        valor = Convert.ToInt32(dr["CODIGO_ZONA"].ToString());
                    }
                    dr.Close();
                }
            }
        ...
        //Toby--> validar si pertenece a nivle resolutivo 
        public bool EsAdminNivelResolutivo(string pa_user)
        {
            DataTable dt = new DataTable();
            bool sAdminNivelResolutivo = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT count(*) FROM WFC.DCS_WF_USUARIOS_ESTACIONES
                                    WHERE USUARIO = :pa_usuario
                                    AND ACTIVO = 'S'
                                    AND ESTACION_ID = 1001";
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    da.SelectCommand.Parameters.Add("pa_usuario", pa_user);
                    try
                    {
                        da.Fill(dt);
                        if (dt.Rows.Count > 0)
                        {
                            sAdminNivelResolutivo = true;
                        }
                    }
                    catch (Exception e)
                    {
                        sAdminNivelResolutivo = false;
                        //throw new Exception("Error en " + e.TargetSite.ToString() + " " + e.Message);
                    }
                }
            }
            ...
            return sAdminNivelResolutivo;
        }

        //valida las zonas y rango de fecha de admin temporal
        public DataTable DatosTemporal(string pa_user, int pa_zon)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    ...
                    OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
                    da.SelectCommand.Parameters.Add("pa_usuario", pa_user);
                    da.SelectCommand.Parameters.Add("pa_zona", pa_zon);
                    try
                    {
                        da.Fill(dt);
                    }
        ...
        public bool ProcesarResolucionSolicitud(string p_usuario_comite, string p_decision, string p_comentarios, Int32 p_no_solicitud, Int32 re, string resp, out string pa_estado_final)
		{
			bool vl_retorno = false;
			OracleCommand cmd = new OracleCommand();
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.Parameters.Add("pa_no_solicitud", OracleType.Number).Value = p_no_solicitud;
                    cmd.Parameters.Add("pa_cod_rechazo", OracleType.Number).Value = re;
                    cmd.Parameters.Add("pa_rechazo", OracleType.VarChar, 50).Value = resp;
        ...
        public DataTable ObtenerAdmineResolucion(Int32 p_no_solicitud)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT E.NOMBRE
                                      FROM WFC.DCS_SOLICITUDES S, WFC.DCS_SOLICITUDES_APROBACIONES A, WFC.DCS_WF_ESTACIONES E
                                    WHERE S.NO_SOLICITUD = A.NO_SOLICITUD
		...
		public bool ActualizarPrestaciones(int no_excepcion, decimal prestaciones)
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.CommandText = sql;
					cmd.Connection = ConexionOracle;
					cmd.Parameters.Add("pa_prestaciones", OracleType.Number).Value = prestaciones;
					cmd.Parameters.Add("pa_codigo_excepcion", OracleType.Number).Value = no_excepcion;
        ...
        public DataTable ObtenerValoresLiquidacion(Int32 p_no_solicitud, Int32 p_codigo_sub_aplicacion, string p_fondos, Int32 p_destino_credito, int p_edad, int p_plazo,
            string p_toma_seguro_vida, double p_honorarios_compra_venta, double avaluo_mejoras, double p_monto, double p_cuota, double p_valor_aportmensual,
             double p_valor_coopsalud, double p_tasa, double monto_recibir)
        {
            ...
            double vl_cat = 0;
            double vl_tir = 0;
            double vl_prima_seguro = 0;
            double vl_prima_incedios = 0;
            double gastos_operativos = 0;
            string tipo_persona = string.Empty;
			...
			dt.Columns.Add("cat");
			dt.Columns.Add("GUID");
            dt.Columns.Add("prima_seguro");
            dt.Columns.Add("prima_incedios");
            ...
            if (p_toma_seguro_vida == "S")
            {
                ...
                //if (p_edad <= 63)
                vl_seguros_vida = (p_monto / 1000) * 4.5;
                //else
                ...
                //        6   Vivienda
                //        7   Mejoras de Vivi.
                //        8   Liberacion de Hipotecas
                //        9   Construccion
                //        14  Compra de Terrrenos
                //        24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                //        25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                //        26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                //    50  PROYECTOS HABITACIONALES COOPSAFA
                //        19  PROYECTO URBANIZAR VIVIENDAS
                //        20  PROYECTO CONSTRUIR VIVIENDAS
                //    51  PROYECTOS HABITACIONALES FEC
                //        19  PROYECTO URBANIZAR VIVIENDAS
                //        20  PROYECTO CONSTRUIR VIVIENDAS
                if (p_fondos == "Fondos Propios")
                {
                    if (p_codigo_sub_aplicacion == 3)
                    {
                        if (p_destino_credito == 6 || p_destino_credito == 7 || p_destino_credito == 8 || p_destino_credito == 9 || p_destino_credito == 14
                            || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                        {
                            vl_prima_seguro = vl_seguros_vida_mensual * 6;
                        }
                    }
                    if (p_codigo_sub_aplicacion == 50)
                    {
                        if (p_destino_credito == 19 || p_destino_credito == 20)
                        {
                            vl_prima_seguro = vl_seguros_vida_mensual * 6;
                        }
                    }
                    if (p_codigo_sub_aplicacion == 51)
                    {
                        if (p_destino_credito == 19 || p_destino_credito == 20)
                        {
                            vl_prima_seguro = vl_seguros_vida_mensual * 6;
                ...
                else
                {
                    ...
                    //        25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                    //        26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                    //    64  PROYECTOS HABITACIONAL RAP
                    //        19  PROYECTO URBANIZAR VIVIENDAS
                    //        20  PROYECTO CONSTRUIR VIVIENDAS
                    if (p_fondos == "Fondos Rap")
                    {
                        if (p_codigo_sub_aplicacion == 63)
                        {
                            if (p_destino_credito == 6 || p_destino_credito == 7 || p_destino_credito == 8 || p_destino_credito == 9 || p_destino_credito == 14
                                || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26 || p_destino_credito == 57)
                            {
                                vl_prima_seguro = vl_seguros_vida_mensual * 6;
                            }
                        }
                        if (p_codigo_sub_aplicacion == 64)
                        {
                            if (p_destino_credito == 19 || p_destino_credito == 20)
                            {
                                vl_prima_seguro = vl_seguros_vida_mensual * 6;
                    ...
                    {
                        //fondos BANHPROVI
                        //        44  VIVIENDA CLASE MEDIA BANHPROVI
                        //    6   Vivienda
                        //    7   Mejoras de Vivi.
                        //    24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                        //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //47  TASA PREFERENCIAL VIVIENDA BANHPROVI
                        //    6   Vivienda
                        //    24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                        //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //48  VIVIENDA PARA UNA VIDA MEJOR BANHPROVI
                        //    24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                        //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //49  VIVIENDA DIGNA BANHPROVI
                        //    24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                        //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //67  PF REDESCTO CLASE MEDIA BANHPROVI
                        //    6   Vivienda
                        //    24  COMPRA DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                        //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                        //46  PROYECTOS HABITACIONES BANHPROVI
                        //    19  PROYECTO URBANIZAR VIVIENDAS
                        //    20  PROYECTO CONSTRUIR VIVIENDAS
                        if (p_fondos == "Fondos Banhprovi")
                        {
                            if (p_codigo_sub_aplicacion == 44)
                            {
                                if (p_destino_credito == 6 || p_destino_credito == 7
                                    || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                                }
                            }
                            if (p_codigo_sub_aplicacion == 46)
                            {
                                if (p_destino_credito == 6 || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                                }
                            }
                            if (p_codigo_sub_aplicacion == 47)
                            {
                                if (p_destino_credito == 6 || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                            ...
                            if (p_codigo_sub_aplicacion == 48)
                            {
                                if (p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                                }
                            }
                            if (p_codigo_sub_aplicacion == 49)
                            {
                                if (p_destino_credito == 19 || p_destino_credito == 20)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                            ...
                            if (p_codigo_sub_aplicacion == 67)
                            {
                                if (p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26 || p_destino_credito == 6)
                                {
                                    vl_prima_seguro = vl_seguros_vida_mensual * 6;
                                }
                            }
                ...
                if (vl_prima_seguro == 0)
                {
                    vl_prima_seguro = vl_seguros_vida_mensual * 12;
                }
            }
            ...
            //Segun nuevos cambios se cambio la tasa de 5.5 a 2.77 por millar 

            double temporal = ((avaluo_mejoras / 1000) * 2.77);
            vl_seguro_incendios = temporal;
            ...
            if (p_fondos == "Fondos Propios")
            {
                if (p_codigo_sub_aplicacion == 3)
                {
                    if (p_destino_credito == 6 || p_destino_credito == 7 || p_destino_credito == 8 || p_destino_credito == 9 || p_destino_credito == 14
                        || p_destino_credito == 24 || p_destino_credito == 25 || p_destino_credito == 26)
                    {
                        vl_prima_incedios = (vl_seguros_incendios_mensual) * 6;
                    }
                }
                if (p_codigo_sub_aplicacion == 50)
                {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        vl_prima_incedios = vl_seguros_incendios_mensual * 12;
                    }
                }
                
            }
            if (vl_prima_incedios == 0)
            {
                vl_prima_incedios = vl_seguros_incendios_mensual * 12;
            }
            ...
            if (p_fondos == "Fondos Propios")
            {
                //25, 26, 14, 9, 8, 7. 6  * 0.01125
                //1,2,3,4,5, 10,11,12, 15 , 16, 17, 18 , 21, 23 * 0.0125
                if (p_codigo_sub_aplicacion == 3)
                {
                    switch (p_destino_credito)
                    {
                        case 6:
                            vl_honorarios_hipoteca = (p_monto * 0.01125);
                            break;
                        case 7:
                            vl_honorarios_hipoteca = (p_monto * 0.01125);
                            break;
                        ...
                        case 26:
                            ...
                            break;
                        case 1:
                            vl_honorarios_hipoteca = (p_monto * 0.0125);
                            break;
                        case 2:
                            vl_honorarios_hipoteca = (p_monto * 0.0125);
                            break;
                ...
                {
                    switch (p_codigo_sub_aplicacion)
                    {
                        ...
                        case 50:
                            if (p_destino_credito == 19 || p_destino_credito == 20)
                            {
                                vl_honorarios_hipoteca = (p_monto * 0.0075);
                            }
                            break;
                        case 51:
                            if (p_destino_credito == 19 || p_destino_credito == 20)
            ...
            else
            {
                if (p_fondos == "Fondos Rap")
                {
                    ...
                    if (p_codigo_sub_aplicacion == 65)
                    {
                        if (p_destino_credito == 11)
                            vl_honorarios_hipoteca = (p_monto * 0.0125);
                    }
                }
                else
                {
                    ...
                    //    25  CONSTRUCCION DE VIVIENDA EN LOTE PROPIO
                    //    26  LIBERACION DE LOTE Y CONSTRUCCION DE VIVIENDA
                    //45  PYME HIPOTECARIO BANHPROVI
                    //    todos
                    //46  PROYECTOS HABITACIONES BANHPROVI
                    //    19  PROYECTO URBANIZAR VIVIENDAS
                    //    20  PROYECTO CONSTRUIR VIVIENDAS
                    //71  AGRO CREDITO 8.70  BANHPROVI
                    //    todo
                    if (p_fondos == "Fondos Banhprovi")
                    {
                        if (p_codigo_sub_aplicacion == 44)
            ...
            DataTable dtCuanti = p_datos_AnalisisCuantitativo(p_no_solicitud);
            ...
            if (p_codigo_sub_aplicacion == 71)
            {
                if (tipo_persona == "N")
                {
                    gastos_operativos = p_monto * 0.010;
                }
                if (tipo_persona == "J")
                {
                    gastos_operativos = p_monto * 0.015;
                }
            }
            else
            {
                gastos_operativos = this.ObtieneGastosOperativo(p_codigo_sub_aplicacion, p_monto, monto_recibir, vl_gastos_administrativos);
            }

            //--Cat y tir
            //double gastos = vl_gastos_administrativos + vl_central_riesgo + vl_papeleria;
            double gastos = gastos_operativos + vl_central_riesgo + vl_papeleria;
            ...
            dt.Rows.Add(vl_cuota_anticipada, 0, 0, 0, 0, vl_timbres_cooperativos, vl_honorarios_hipoteca, p_honorarios_compra_venta, vl_capitalizacion, vl_seguros_vida, vl_seguro_danos, vl_seguro_incendios,
                        ...
                        vl_tir, vl_cat, guid_generado, vl_prima_seguro, vl_prima_incedios);

            return dt;
        }

        public void ActualizarMontoGastos(Int32 p_no_solicitud, double p_monto_cobronuevo)
        {
            OracleCommand cmd = new OracleCommand();
            try
            {
        ...
        public void ActualizarMontoGastosDV(Int32 p_no_solicitud, double p_monto_cobronuevo)
        {
            OracleCommand cmd = new OracleCommand();
            try
            {
        ...
        public void ActualizarMontoGastosDI(Int32 p_no_solicitud, double p_monto_cobronuevo)
        {
            OracleCommand cmd = new OracleCommand();
            try
            {
        ...
        public bool GenerarCAT2021(double p_monto, double p_monto_recibido, double p_tasa, Int32 p_plazo, Int32 p_solicitud)
        {
            bool vl_retorno = false;
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"DCS_P_CALCULAR_TIR_CAT_2021";
                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    ConexionOracle.Open();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("pa_monto_prestamo", OracleType.Number).Value = p_monto;
                    cmd.Parameters.Add("pa_monto_recibido", OracleType.Number).Value = p_monto_recibido;
                    cmd.Parameters.Add("pa_tasa", OracleType.Number).Value = p_tasa;
                    cmd.Parameters.Add("pa_plazo_meses", OracleType.Number).Value = p_plazo;
        ...
        public DataTable ObtenerEstadoSolicitud()
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"Select 0 estado_id,'Todos los Estados' descripcion from dual union
                                    Select 3 estado_id,'Aprobada/Desembolsada Y Cerrado' descripcion from dual union
                                    Select 4 estado_id,'Rechazada/Rechazada Y Cerrada' descripcion from dual union
                                    select ESTADO_ID,InitCap(Descripcion) descripcion from dcs_wf_estado_solicitudes 
                                    where activo='S'
                                    and ESTADO_ID in (1,2,98)";
					OracleDataAdapter da = new OracleDataAdapter(sql, ConexionOracle);
					try
					{
						da.Fill(dt);
		...
		public bool InsertarSolicitudCredito(solicitud_credito solicitud, out Int32 p_no_solicitud, GaranteHipotecario garante)
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.Parameters.Add("pa_dependientes_hijos_conyuge", OracleType.Number).Value = solicitud.dependientes_hijos_conyuge;
					cmd.Parameters.Add("pa_dependientes_otros_conyuge", OracleType.Number).Value = solicitud.dependientes_otros_conyuge;
					...
					cmd.Parameters.Add("pa_dependientes_hijos_codeudor", OracleType.Number).Value = solicitud.dependientes_hijos_codeudor;
					cmd.Parameters.Add("pa_dependientes_otros_codeudor", OracleType.Number).Value = solicitud.dependientes_otros_codeudor;
					...
					cmd.Parameters.Add("pa_dependientes_hijos_aval1", OracleType.Number).Value = solicitud.dependientes_hijos_aval1;
					cmd.Parameters.Add("pa_dependientes_otros_aval1", OracleType.Number).Value = solicitud.dependientes_otros_aval1;
					...
					cmd.Parameters.Add("pa_dependientes_hijos_aval2", OracleType.Number).Value = solicitud.dependientes_hijos_aval2;
					cmd.Parameters.Add("pa_dependientes_otros_aval2", OracleType.Number).Value = solicitud.dependientes_otros_aval2;
					...
					cmd.Parameters.Add("pa_edad_presta", OracleType.Number).Value = solicitud.EdadPresta;
					cmd.Parameters.Add("pa_edad_aval1", OracleType.Number).Value = solicitud.EdadAval1;
					cmd.Parameters.Add("pa_edad_aval2", OracleType.Number).Value = solicitud.EdadAval2;
					cmd.Parameters.Add("pa_nivel_educativo_cony", OracleType.VarChar, 1).Value = solicitud.NivelEducConyuge;
					...
					cmd.Parameters.Add("pa_tipo_contrato", OracleType.VarChar, 20).Value = solicitud.TipoContrato;
					cmd.Parameters.Add("pa_rtn_solicitante", OracleType.VarChar, 25).Value = solicitud.RTN;
					...
					cmd.Parameters.Add("pa_requiere_garante", OracleType.VarChar, 1).Value = solicitud.RequiereGarante;
					cmd.Parameters.Add("pa_estado_civil_co", OracleType.VarChar, 20).Value = solicitud.EstadoCivilCodeudor;

					cmd.Parameters.Add("pa_estado_civil_aval1", OracleType.VarChar, 20).Value = solicitud.EstadoCivilAval1;
					cmd.Parameters.Add("pa_estado_civil_aval2", OracleType.VarChar, 20).Value = solicitud.EstadoCivilAval2;
					cmd.Parameters.Add("pa_estado_civil_pres", OracleType.VarChar, 20).Value = solicitud.estado_civil;
					//
					cmd.Parameters.Add("pa_edad_codeudor", OracleType.Number).Value = solicitud.EdadCodeudor;
					cmd.Parameters.Add("pa_rtn_codeudor", OracleType.VarChar, 25).Value = solicitud.RTN_Codeudor;
					cmd.Parameters.Add("pa_fecha_ingreso_sol", OracleType.VarChar, 20).Value = solicitud.FechaIngresoLaboral;
					cmd.Parameters.Add("pa_fecha_ingreso_cod", OracleType.VarChar, 20).Value = solicitud.FechaIngresoLaboralCodeudor;
					cmd.Parameters.Add("pa_fecha_ingreso_aval1", OracleType.VarChar, 20).Value = solicitud.FechaIngresoLaboralAval1;
					cmd.Parameters.Add("pa_fecha_ingreso_aval2", OracleType.VarChar, 20).Value = solicitud.FechaIngresoLaboralAval2;
					//
					cmd.Parameters.Add("pa_monto_cuota_venc_co", OracleType.Number).Value = solicitud.MontoCuotasVencCodeudor;
					cmd.Parameters.Add("pa_monto_cuota_venc_aval1", OracleType.Number).Value = solicitud.MontoCuotasVencAval1;
					cmd.Parameters.Add("pa_monto_cuota_venc_aval2", OracleType.Number).Value = solicitud.MontoCuotasVencAval2;
					cmd.Parameters.Add("pa_deudas_desc_sol", OracleType.Number).Value = solicitud.DeudasDescSol;
					cmd.Parameters.Add("pa_deudas_desc_co", OracleType.Number).Value = solicitud.DeudasDescCod;
					cmd.Parameters.Add("pa_deudas_desc_aval1", OracleType.Number).Value = solicitud.DeudasDescAval1;
					cmd.Parameters.Add("pa_deudas_desc_aval2", OracleType.Number).Value = solicitud.DeudasDescAval2;
				...
				if (solicitud.RequiereGarante.Equals("S"))
				{
					using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
					{
						...
						cmd.Parameters.Add("pa_no_solicitud", OracleType.Number).Value = p_no_solicitud;
						cmd.Parameters.Add("pa_no_ident_garante", OracleType.VarChar).Value = garante.NoIdentidadGarante;
						...
						cmd.Parameters.Add("pa_tipo_emp_otros_g", OracleType.VarChar, 50).Value = garante.TipoEmpresaOtrosGarante;
						...
						cmd.Parameters.Add("pa_ext1_lab_gar", OracleType.VarChar, 10).Value = garante.ExtLab1Garante;
						cmd.Parameters.Add("pa_tel2_lab_gar", OracleType.VarChar, 20).Value = garante.TelLab2Garante;
						cmd.Parameters.Add("pa_ext2_lab_gar", OracleType.VarChar, 10).Value = garante.ExtLab2Garante;
						cmd.Parameters.Add("pa_dir_lab_gar", OracleType.VarChar, 100).Value = garante.DirecLabGarante;
						cmd.Parameters.Add("pa_correo_lab_gar", OracleType.VarChar, 50).Value = garante.CorreoLabgarante;
						cmd.Parameters.Add("pa_nom_cony_gar", OracleType.VarChar, 100).Value = garante.NomConyugeGarante;
						cmd.Parameters.Add("pa_dir_lab_cony_gar", OracleType.VarChar, 100).Value = garante.DirecLabConyuGarante;
						cmd.Parameters.Add("pa_cargo_cony_gar", OracleType.VarChar, 100).Value = garante.CargoLabConyuGarante;
						cmd.Parameters.Add("pa_nom_ref1_gar", OracleType.VarChar, 100).Value = garante.NomRef1Garante;
						cmd.Parameters.Add("pa_dir_ref1_gar", OracleType.VarChar, 100).Value = garante.DirRef1Garante;
						cmd.Parameters.Add("pa_tel_ref1_gar", OracleType.VarChar, 20).Value = garante.TelRef1Garante;
						cmd.Parameters.Add("pa_loc_ref1_gar", OracleType.VarChar, 100).Value = garante.LocalRef1Garante;
						cmd.Parameters.Add("pa_cel_ref1_gar", OracleType.VarChar, 20).Value = garante.CelularRef1Garante;
						cmd.Parameters.Add("pa_nom_ref2_gar", OracleType.VarChar, 100).Value = garante.NomRef2Garante;
						cmd.Parameters.Add("pa_dir_ref2_gar", OracleType.VarChar, 100).Value = garante.DirRef2Garante;
						cmd.Parameters.Add("pa_tel_ref2_gar", OracleType.VarChar, 20).Value = garante.TelRef2Garante;
						cmd.Parameters.Add("pa_loc_ref2_gar", OracleType.VarChar, 100).Value = garante.LocalRef2Garante;
						cmd.Parameters.Add("pa_cel_ref2_gar", OracleType.VarChar, 20).Value = garante.CelularRef2Garante;
						cmd.Parameters.Add("pa_nom_ref3_gar", OracleType.VarChar, 100).Value = garante.NomRef3Garante;
						cmd.Parameters.Add("pa_dir_ref3_gar", OracleType.VarChar, 100).Value = garante.DirRef3Garante;
						cmd.Parameters.Add("pa_tel_ref3_gar", OracleType.VarChar, 20).Value = garante.TelRef3Garante;
						cmd.Parameters.Add("pa_edad_garante", OracleType.Number).Value = garante.EdadGarante;
						cmd.Parameters.Add("pa_tipo_vivienda_gar", OracleType.VarChar, 12).Value = garante.TipoViviendaGar;
						cmd.Parameters.Add("pa_vivienda_gar", OracleType.VarChar, 50).Value = garante.ViviendaGarante;
		...
		public solicitud_credito ObtenerSolicitudCredito(Int32 p_no_solicitud)
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"Select nombres,primer_apellido,segundo_apellido,apellido_de_casada, f.descripcion_fuente descripcion_fuente,
					...
					try
					{
                        ...
                        sol.descripcion_fuente = dt.Rows[0]["descripcion_fuente"].ToString();
        ...
        public float ObtenerCuotaNivela(int p_codigo_sub_app, float p_monto, decimal p_tasa, float p_plazo)
		{
			float vl_retorno = 0;
        ...
        public DataTable ObtenerDatosClientexCodigoCliente(string p_codigo_cliente)
		{
            ...
            dt.Columns.Add("TIPO_DE_PERSONA");
            try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"select numero_identificacion,nombres,primer_apellido,segundo_apellido,
                                          ...
                                          fecha_de_nacimiento,
                                          apellido_de_casada,notaria, codigo_tipo_identificacion, TIPO_DE_PERSONA   
                                     from mgi_clientes 
                                    where codigo_cliente=:pa_codigo_cliente ";
        ...
        //Toby--> obtener datos para miembro por cuenta
        public DataTable ObtenerDatosCodigoClienteAddMember(string p_codigo_cliente)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"select codigo_cliente, numero_identificacion,nombres,primer_apellido,segundo_apellido, codigo_tipo_identificacion  
                                     from mgi_clientes  
                                    where codigo_cliente=:pa_codigo_cliente";
                    ...
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            ...
                            dt.Rows.Add(dr["codigo_cliente"],
                                        dr["numero_identificacion"],
                                        dr["nombres"],
                                        dr["primer_apellido"],
                                        dr["segundo_apellido"],
                                        dr["codigo_tipo_identificacion"]);
        ...
        //Toby--> obtener datos para miembro por id
        public DataTable ObtenerDatosMemberxIdentificacion(string p_numero_identificacion)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"Select codigo_cliente,
                                    ...
                                    where cl.numero_identificacion=:pa_numero_identificacion ";
                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
        ...
        //Toby--> obtener datos de busqueda
        public DataTable ObtenerBusqueda(int p_cod, string p_numero_identificacion, string p_nombre)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"--Mostrar historico  
                                    select A.NOMBRE, A.IDENTIDAD, A.COD_CLIENTE, B.TIPO_MIEMBRO AS MIEMBRO, C.DESCRIPCION AS ZONA, A.ACTIVO
                                        from WFC.DCS_MIEMBROS A
                                    INNER JOIN WFC.DCS_WF_TIPO_MIEMBRO B
                                    ON A.ID_TIPO_MIEMBRO = B.ID_TIPO_MIEMBRO
                                    INNER JOIN cef_zonas C
                                    ON A.CODIGO_ZONA = C.CODIGO_ZONA
                                    where A.COD_CLIENTE =:pa_cod
                                    OR A.NOMBRE =:pa_numero_identificacion
                                    OR A.IDENTIDAD =:pa_nombre ";
                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.AddWithValue("pa_cod", p_cod);
                    OracleDataAdapter da = new OracleDataAdapter(cmd);
                    try
                    {
                        da.Fill(dt);
        ...
        public DataTable ObtenerDatosClientexIdentificacionJ(string p_numero_identificacion)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"Select cl.codigo_cliente,
                                          numero_identificacion,
                                          (nombres|| ' ' ||primer_apellido|| ' ' ||segundo_apellido|| ' ' ||apellido_de_casada) nombre,
                                          cl.codigo_tipo_cliente,
                                          cl.fecha_de_nacimiento,
                                          cl.objetivo_social tipo_vivienda,                                                                                 
                                          p.descripcion profesion_oficio,
		...
		//Listo
		public DataTable ObtenerDestinoCredito(int tipo_prestamo)
		{
			DataTable dt = new DataTable();
			OracleCommand cmd = new OracleCommand();
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"Select d.destino_id, d.descripcion_destino, d.activo_b, d.PLAZO_DESTINO, d.tasa_destino, d.DESTINO_ORIGEN
                                    from dcs_wf_destinos_credito d,
                                    (SELECT A.COD_GASTO, A.DES_GASTO
                                    FROM SX_TIPO_NATURALEZA_GASTO A
                                    WHERE A.IND_ACTIVO = 'S'
                                      AND
                                      (
                                       (
                                        (SELECT COUNT(*) FROM CR_TIPO_PRESTAMO_GASTO B WHERE B.COD_TIPOPRES = :COD_TIPOPRES AND B.IND_ACTIVO = 'S') > 0
                                         AND
                                         A.COD_GASTO IN(SELECT B.COD_GASTO FROM CR_TIPO_PRESTAMO_GASTO B WHERE B.COD_TIPOPRES = :COD_TIPOPRES AND B.IND_ACTIVO = 'S')
                                      )
                                       OR
                                       (
                                        (SELECT COUNT(*) FROM CR_TIPO_PRESTAMO_GASTO B WHERE B.COD_TIPOPRES = :COD_TIPOPRES AND B.IND_ACTIVO = 'S') = 0
                                    ...
                                    ORDER BY A.COD_GASTO) mcr
                                    where d.activo_b='S'
                                     and mcr.COD_GASTO = d.DESTINO_ORIGEN
                                    ";
					cmd.CommandText = sql;
					cmd.Connection = ConexionOracle;
                    //cmd.Parameters.AddWithValue("pa_activo_b", 'S');
                    cmd.Parameters.AddWithValue("COD_TIPOPRES", tipo_prestamo);
                    OracleDataAdapter da = new OracleDataAdapter(cmd);
					try
					{
						da.Fill(dt);
        ...
        //Toby--> obtener las Areas par reportes
        public DataTable ObtenerMotivosRechazoXSol(Int32 p_no_solicitud)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"SELECT A.FECHA_DECISION, A.DECISION, A.RECHAZO
                                    FROM WFC.DCS_SOLICITUDES S,
                                        WFC.DCS_SOLICITUDES_APROBACIONES A       
                                    WHERE S.NO_SOLICITUD = A.NO_SOLICITUD
                                    AND A.DECISION = 'RECHAZADO'
                                    AND S.NO_SOLICITUD=:pa_no_solicitud 
                                    GROUP BY A.DECISION, A.RECHAZO, A.FECHA_DECISION
                                    ORDER BY A.FECHA_DECISION DESC";
                    cmd.CommandText = sql;
                    cmd.Connection = ConexionOracle;
                    cmd.Parameters.AddWithValue("pa_no_solicitud", p_no_solicitud);
                    OracleDataAdapter da = new OracleDataAdapter(cmd);
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"Select upper(es.descripcion) estado_solicitud,
                                          ...
                                          no_acta_resolucion,
                                          ciudad_resolucion,
                                          no_identidad_codeudor||'  '||rtrim(primer_nombre_codeudor)||' '||rtrim(segundo_nombre_codeudor)||' '||rtrim(primer_apellido_codeudor||' '||rtrim(SEGUNDO_APELLIDO_CODEUDOR)) codeudor,
        ...
        public DataTable p_obtenerFirmasExcepciones(Int32 p_cod_excepcion)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    ...
                    try
                    {
                        da.SelectCommand.Parameters.Add("PA_CODIGO_EXCEPCION", p_cod_excepcion);
                        da.Fill(dt);
                    }
                    catch (Exception e)
                    {
        ...
        //                  Para Excepciones
        //----------------------------------------------------------------------
        public DataTable p_firmas_EXCP(Int32 p_no_excepcion, string p_usuario)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
                ...
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"Select usuario_comite,b.codigo_cliente,
                                 ...
                                 From EXCP.DCS_EXCEPCIONES_APROBACIONES a,
                                      MGI.MGI_USUARIOS b,
                                      MRH.MRH_EMPLEADOS_FIRMAS c
                                Where a.codigo_excepcion =:pa_no_excepcion
                                  and a.usuario_comite=b.codigo_usuario
                                  and b.codigo_cliente=c.codigo_cliente(+)
                                  and usuario_comite=:pa_usuario_miembro
                                  and ROWNUM = 1";
                    ...
                    try
                    {
                        da.SelectCommand.Parameters.Add("pa_no_excepcion", p_no_excepcion);
                        da.SelectCommand.Parameters.Add("pa_usuario_miembro", p_usuario);
                        da.Fill(dt);
                    }
                    catch (Exception e)
        ...
        //obtener el id de comite
        public int p_comiteID(Int32 p_no_solicitud)
        {
            DataTable dt = new DataTable();
            OracleCommand cmd = new OracleCommand();
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    string sql = @"select DISTINCT COMITE_ID From dcs_solicitudes_aprobaciones
                                    where NO_SOLICITUD =:pa_no_solicitud";
           ...
           return Convert.ToInt32(dt.Rows[0]["COMITE_ID"].ToString());
        }

        public DataTable p_firmas_miembro2(Int32 p_no_solicitud, string p_usuario, bool p_comite = false)
		{
			DataTable dt = new DataTable();
			OracleCommand cmd = new OracleCommand();
			try
        ...
        public DataTable p_firmas_miembro3(Int32 p_no_solicitud, string p_usuario, bool p_comite = false)
		{
			DataTable dt = new DataTable();
			OracleCommand cmd = new OracleCommand();
			try
        ...
        public DataTable p_datos_AnalistaObserva(Int32 p_no_solicitud)
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"SELECT s1.codigo_cliente,
                                          s1.no_solicitud,
                                          s2.numero_identificacion,
                                          cl.nombres||cl.primer_apellido||' '||cl.segundo_apellido nombre_completo,
                                          desc_sub_aplicacion producto,
                                          s1.monto_solicitado monto_solicitado,
                                          plazo plazo_sol,
                                          tasa tasa_sol,
                                          oficial_servicio usuario_analista,
                                          u.nombres||' '||u.primer_apellido||' '||u.segundo_apellido nombre_analista,
                                          de.DESCRIPCION_DESTINO,
                                          f.descripcion_fuente,
                                          m.NOMBRE_AGENCIA,
                                          observaciones_analista
        ...
        public DataTable p_datos_HojaRuta2(Int32 p_no_solicitud)
		{
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					string sql = @"select c.numero_identificacion,
                                        s1.codigo_cliente,c.nombres||' '||c.primer_apellido||' '||c.segundo_apellido nombre_completo,                                          
                                        s2.monto_solicitado,
                                        s2.plazo,
                                        S2.TASA,
                                        s2.codigo_sub_aplicacion,
                                        ...
                                        nombre_agencia,
                                        nvl(s2.tipo_persona, 'Persona Natural')tipo_persona,
                                        f.DESCRIPCION_FUENTE
                                    from dcs_solicitudes s1,
                                        dcs_solicitudes2 s2,
                                        mgi_clientes c,
                                        ...
                                        mgi_usuarios u,
                                        mgi_agencias ag,
                                        WFC.DCS_WF_FUENTES_FINANCIAMIENTO f
			...
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
                    string sql = @"SELECT decode(d.PERSONA_SOLICITUD,'P1','SOLICITANTE','P2','CODEUDOR','P3','AVAL1','P4','AVAL2') PERSONA,
                                      decode(dw.SECCION, 'P', 'SECCION PRIMARIA', 'L', 'SECCION LEGAL', 'F', 'SECCION FINACIERA', 'O', 'CORRESPONDECIA Y OTROS') SECCION,
                                      dw.DOCUMENTO_ID,
                                      d.DESCRIPCION,
                                      dw.TIPO_EXIGENCIA,
                                      DCS_F_TIENE_ADJUTOXDOC_ID(s.NO_SOLICITUD,dw.DOCUMENTO_ID) adjunto 
                                 FROM WFC.DCS_WF_DOCUMENTOS_WORKFLOW dw,       
                                      WFC.DCS_WF_TIPO_DOCUMENTOS d,       
                                      WFC.DCS_SOLICITUDES s,
                                      WFC.DCS_SOLICITUDES2 s2       
                                WHERE s.NO_SOLICITUD =:pa_no_solicitud
                                  ...
                                  AND D.PERSONA_SOLICITUD IN ('P1',
                                                              ...
                                                              decode(REQUIERE_LEGAL1,'S','P5'),
                                                              decode(REQUIERE_LEGAL2,'S','P6'),
                                                              decode(REQUIERE_LEGAL3,'S','P7'))
                                ORDER BY d.PERSONA_SOLICITUD,orden_in_grupo, SECCION 
                                DESC";
                    try
					{
						cmd.CommandText = sql;
        ...
        public DataTable p_datos_reporte_Ad(DateTime d1, DateTime d2, string p_regional, string p_filial, string p_estado, string p_no_solicitud, string p_estacion)
        {
            string sql;
            ...
            string scondi_estacion = "";
            string scondi_admin = ", TO_CHAR(lg.FECHA_EVENTO), TO_CHAR(lg.DESCRIPCION_EVENTO), TO_CHAR(lg.VALOR_NUEVO)";
            scondi_fechas = " and S1.fecha_presentacion between :pa_date1 and :pa_date2";
            ...
            if (!string.IsNullOrEmpty(p_estado))
            {
                ...
                if (p_estado == "3")
                {
                    scondi_estado = " and s1.estado_solicitud_id in (3,5)";
                }
                if (p_estado == "4")
                {
                    scondi_estado = " and s1.estado_solicitud_id in (4,6)";
                }
                if (p_estado == "1" || p_estado == "2" || p_estado == "98")
                {
                    scondi_estado = " and s1.estado_solicitud_id=" + p_estado;
                }
            }
            ...
            if (p_estacion == "0")
            {
                scondi_estacion = "and est.estacion_id=" + p_estacion;
            }
            ...
            try
            {
                using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
                {
                    if (p_estacion == "0")
                    {
                        sql = @"SELECT (CL.nombres||' '||CL.primer_apellido||' '||CL.segundo_apellido) nombre_afiliado,
                                             EX.NO_SOLICITUD,
                                             EX.CODIGO_EXCEPCION,
                                        ...
                                        FROM EXCP.DCS_EXCEPCION_SOLICITUD EX, 
                                             EXCP.DCS_EXC_ESTADOS_EXCEPCION EE, 
                                             EXCP.DCS_DETALLE_EXCEP_SOLIC DE, 
                                             WFC.DCS_SOLICITUDES S1,
                                             MGI.MGI_CLIENTES CL
                                        WHERE EX.NO_SOLICITUD = S1.NO_SOLICITUD
                                              AND EX.CODIGO_ESTADO_EXCEP = EE.ESTADO_EXCEP_ID
                                              AND EX.CODIGO_EXCEPCION = DE.CODIGO_EXCEPCION
                                              AND S1.CODIGO_CLIENTE = CL.CODIGO_CLIENTE  " +
                                        scondi_fechas + @"
                                GROUP BY  CL.nombres||' '||CL.primer_apellido||' '||CL.segundo_apellido,  
                                             EX.NO_SOLICITUD, 
                                             EX.CODIGO_EXCEPCION,
                                             EX.FECHA_PRESENTACION,
                                             EX.FECHA_RESOLUCION,
                    ...
                    {
                        if (p_estado == "1" || p_estado == "2")
                        {
                            sql = @"select s1.no_solicitud, 
                                       s1.codigo_cliente,
                                       cl.nombres||' '||cl.primer_apellido||' '||cl.segundo_apellido nombre_afiliado,
                                       s1.FECHA_PRESENTACION,
                                       s1.FECHA_APROBACION_RECHAZO,
                                       s1.monto_solicitado,
                                       NVL(s2.MONTO_APROBADO,0) MONTO_APROBADO,
                                       es.DESCRIPCION Estado_solicitud,
                                       sa.desc_sub_aplicacion,
                                       dest.descripcion_destino,
                                       age.nombre_agencia,
                                       az.codigo_zona,
                                       zon.DESCRIPCION
                                from dcs_solicitudes s1,
                                     mgi_clientes cl,
                                     WFC.DCS_WF_ESTADO_SOLICITUDES es, 
                                ...
                                and az.CODIGO_ZONA = zon.CODIGO_ZONA
                        ...
                        else
                        {
                            ...
                            sql = @"SELECT s1.no_solicitud,
                                        s1.codigo_cliente,
                                        nombres||' '||primer_apellido||' '||segundo_apellido nombre_afiliado,
                                        fecha_presentacion,
                                        s1.FECHA_APROBACION_RECHAZO,
                                        s1.monto_solicitado,
                                        s2.monto_aprobado,
                                        ...
                                        az.codigo_zona,
                                        zon.DESCRIPCION, 
                                        dcs_f_obt_comite_resol(s1.no_solicitud) comite_resol " +
                                           scondi_admin
                                           + @",nombre nombre_comite_resol
                                    from dcs_solicitudes s1,
                                         dcs_solicitudes2 s2,
                                         mgi_sub_aplicaciones sa,
                                         mgi_agencias age,
                                    ...
                                    Where  s1.no_solicitud=s2.no_solicitud
                                        ...
                                        and s1.ESTADO_SOLICITUD_ID = es.ESTADO_ID
                                        and az.CODIGO_ZONA = zon.CODIGO_ZONA
                                        and s1.NO_SOLICITUD = lg.NO_SOLICITUD  " +
                                           scondi_fechas +
                                           scondi_region +
                                           scondi_filial +
                                           scondi_estado +
                                           scondi_nosolic + @"
                                    group by s1.no_solicitud, 
                                                s1.codigo_cliente, 
                                                ...
                                                az.codigo_zona, 
                                                zon.DESCRIPCION, 
                                                dcs_f_obt_comite_resol(s1.no_solicitud), 
                                                nombre " +
                                                   scondi_admin
                                                   + @"
        ...
        public DataTable p_datos_reporte1(DateTime d1, DateTime d2, string p_regional, string p_filial, string p_estado, string p_no_solicitud, string p_estacion)
        {
            string sql;
            string scondi_fechas = "";
            string scondi_region = "";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            sql = @"SELECT s1.no_solicitud,
                                        ...
                                        scondi_admin
                                        + @",nombre nombre_comite_resol,
                                        Round((select (sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Afiliacion                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and e.ESTACION_ID = 1000
                                        and no_solicitud = s1.no_solicitud
                                        group by no_solicitud,nombre),2) horas_afiliacion,
                                    Round((select(sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and e.NOMBRE like '%Comite%'
                                        and no_solicitud = s1.no_solicitud
                                        group by no_solicitud),2) Horas_Comite,
                                    Round((select(sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and e.NOMBRE like '%Credito%'
                                        and no_solicitud = s1.no_solicitud
                                        group by no_solicitud),2) Horas_Credito,
                                    Round((select (sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and no_solicitud = s1.no_solicitud
                                        and e.estacion_id = 3003
                                        group by no_solicitud
                                        ),2) Horas_comite_CEIBA,
                                     Round((select (sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and no_solicitud = s1.no_solicitud
                                        and e.estacion_id = 2003
                                        group by no_solicitud
                                        ),2) Horas_comite_SPS,
                                     Round((select (sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                    ...
                                    Round((select(sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                        ...
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and no_solicitud = s1.no_solicitud
                                        and e.NOMBRE like '%Prestamos%'
                                        group by no_solicitud),2)Horas_prestamos,
                                    Round(( select (sum(antiguedad_meses*730.001)+  sum(antiguedad_dias*24) + sum(antiguedad_horas) + sum(antiguedad_minutos/60)  + sum(antiguedad_segundos/3600))Horas_Total                                              
                                            from dcs_movimientos_solicitudes ms,
                                                dcs_wf_estaciones e
                                        Where ms.estacion_id_to=e.estacion_id(+)
                                        and e.estacion_id = 7000
                                        and no_solicitud = s1.no_solicitud
                                    group by no_solicitud),2) Horas_legal
                                    from dcs_solicitudes s1,
                                         dcs_solicitudes2 s2,
                                         mgi_sub_aplicaciones sa,
                                         mgi_agencias age,
        ...
        public int p_Cantidad_Comites(Int32 p_no_solicitud)
        {
            Int32 resp = 0;
            OracleCommand cmd = new OracleCommand();
            OracleDataReader dr;
		...
		public DataTable GetDocMinisterioPublico(int no_solicitud, int agencia)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.Parameters.Add("agencia", OracleType.Number, 30).Value = agencia;
					cmd.Parameters.Add("solicitud", OracleType.Number, 30).Value = no_solicitud;
					cmd.CommandType = CommandType.Text;
					ConexionOracle.Open();
		...
		public DataTable get_detalle_info(int _codExcepcion)
		{
			try
			{
				...
				string sql = "select d.cod_lineamiento, l.nombre lineamiento, d.cod_tipo_excepcion, t.tipo_excepcion,d.JUSTIFICACION Observaciones, cod_detalle_excep "
        ...
        //toby--> trae la informacion de registro y de numero de movimiento para una solicitud
        public DataTable get_detalle_sol(int codSolicitud, string user)
        {
            try
            {
                DataTable dt = new DataTable();
                ...
                string sql = @"SELECT
                                    NO_MOVIMIENTO_ACTUAL
                                FROM WFC.DCS_SOLICITUDES_APROBACIONES
                                    WHERE NO_SOLICITUD = :pa_cod
                                    AND USUARIO_COMITE = :pa_user";

                OracleParameter pa_codSolicitud = new OracleParameter("pa_cod", OracleType.Number);
                pa_codSolicitud.Direction = ParameterDirection.Input;
                pa_codSolicitud.Value = codSolicitud;
                ...
                {
                    OracleCommand cmd = new OracleCommand(sql, ConexionOracle);
                    cmd.Parameters.Add(pa_codSolicitud);
                    ...
                    while (dr.Read())
                    {
                        dt.Rows.Add(dr["NO_MOVIMIENTO_ACTUAL"].ToString()
                                    );
                    }
                    dr.Close();
                    cmd.Dispose();
        ...
        //toby--> trae la informacion de registro y de numero de movimiento para una excepcion
        public DataTable get_detalle_excp(int codExcepcion, string user) {
            try
            {
                DataTable dt = new DataTable();
                dt.Columns.Add("no_movimiento");
                dt.Columns.Add("registro_ap");

                string sql = @"SELECT
                                    NO_REGISTRO_AP, NO_MOVIMIENTO_ACTUAL
                                FROM EXCP.DCS_EXCEPCIONES_APROBACIONES
                                    WHERE CODIGO_EXCEPCION = :pa_cod
                                    AND USUARIO_COMITE = :pa_user";

                OracleParameter pa_cod_excepcion = new OracleParameter("pa_cod", OracleType.Number);
                pa_cod_excepcion.Direction = ParameterDirection.Input;
                pa_cod_excepcion.Value = codExcepcion;
		...
		public DataTable get_detalle_movimiento_excep(int _codExcepcion)
		{
			try
			{
				...
				OracleParameter pa_cod_excepcion = new OracleParameter("excepcion", OracleType.Number);
				pa_cod_excepcion.Direction = ParameterDirection.Input;
				pa_cod_excepcion.Value = _codExcepcion;
		...
		public DataTable get_adjunto_excepcion(int no_adjunto)
		{
			try
			{
				...
				OracleParameter pa_cod_excepcion = new OracleParameter("noAdjunto", OracleType.Number);
				pa_cod_excepcion.Direction = ParameterDirection.Input;
		...
		{   //cambio
			try
			{
                string sql = @"select s.codigo_cliente,
                                        ...
                                        c.lugar_de_trabajo, 
                                        c.nombre_auditores cargo_que_ocupa,
                                        c.fecha_de_ingreso_pais fecha_ingreso_laboral,
                                    ...
                                    from wfc.dcs_solicitudes s,
                                        mgi.mgi_clientes c,
                                        mgi_sub_aplicaciones sa,
                                        wfc.dcs_wf_destinos_credito d,
                                        wfc.dcs_solicitudes2 s2,
                                        mgi.mgi_agencias a,
                                        mca_cuentas cta,
                                        excp.dcs_excepcion_solicitud ex
                                    ...
                                    order by ex.FECHA_ING_EXCEPCION DESC";
													 ...
													 string codigo_cliente, int tipo_reporte, int? codigo_producto, string tipoPago)
		{
			try
			{
				...
				OracleParameter pa_inicio = new OracleParameter("pa_fecha_inicio", OracleType.DateTime);
				pa_inicio.Direction = ParameterDirection.Input;
				pa_inicio.Value = fecha_inicio;

				OracleParameter pa_final = new OracleParameter("pa_fecha_fin", OracleType.DateTime);
		...
		public DataTable ValorParametro(string codParametro)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					OracleParameter pa_cod_param = new OracleParameter("codParam", OracleType.VarChar);
		...
		public DataTable ContraAvalar(int codCliente, int codFiador)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					cmd.CommandType = CommandType.Text;
					cmd.Parameters.Add("codFiador", OracleType.Number).Value = codFiador;
					cmd.Parameters.Add("codCliente", OracleType.Number).Value = codCliente;
		...
		public bool GuardarAlertaExcepcion(string bandera, int no_solicitud, out bool creada, bool agregar = true)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.CommandType = CommandType.Text;
					if (agregar)
						cmd.Parameters.Add("valor", OracleType.VarChar, 1).Value = bandera;

					cmd.Parameters.Add("noSolicitud", OracleType.Number).Value = no_solicitud;
		...
		public void CambiarBanderaSolicitudExcepcion(string bandera, int no_solicitud)
		{
			try
			{
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					cmd.Parameters.Add("P_NO_SOLICITUD", OracleType.Int32).Value = no_solicitud;
					cmd.Parameters.Add("P_BANDERA", OracleType.VarChar, 30).Value = bandera;
		...
		public DataTable ExcepcionesSemaforo(int estacion_id, string extra = "")
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					cmd.CommandType = CommandType.Text;
					cmd.Parameters.Add("estacion_id", OracleType.Number).Value = estacion_id;
		...
		public DataTable EsNivelResolExcep(int codigo_excepcion, int estacion_id, string usuario)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					cmd.CommandType = CommandType.Text;
					cmd.Parameters.Add("codExcep", OracleType.Number).Value = codigo_excepcion;
					cmd.Parameters.Add("usuario", OracleType.VarChar, 30).Value = usuario;
					cmd.Parameters.Add("estacion", OracleType.Number).Value = estacion_id;
		...
		public string ResolucionDirecta(int codigo_Excepcion, int estado, int estacion_from)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					...
					OracleParameter pa_estado = new OracleParameter("P_ESTADO_ID", OracleType.Number);
					pa_estado.Direction = ParameterDirection.Input;
					pa_estado.Value = estado;

					OracleParameter pa_estacion_from = new OracleParameter("P_ESTACION_FROM", OracleType.Number);
					pa_estacion_from.Direction = ParameterDirection.Input;
					pa_estacion_from.Value = estacion_from;

					OracleParameter pa_mensaje = new OracleParameter("p_mensaje", OracleType.VarChar, 200);
		...
		public DataTable GetResoluciones(int codigo_excepcion)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					cmd.CommandType = CommandType.Text;
					cmd.Parameters.Add("CodExcepcion", OracleType.Number).Value = codigo_excepcion;
		...
		public int GetExcepcionSolicitud(int noSolicitud)
		{
			try
			{
				...
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					OracleParameter p_noSolicitud = new OracleParameter("noSolicitud", OracleType.Number);
		...
		public void ActualizarMensajes(int no_entrada, string valor)
		{
			try
			{
				...
				using (OracleConnection ConexionOracle = new OracleConnection(cadenaConexionOracle))
				{
					OracleCommand cmd = new OracleCommand(query, ConexionOracle);
					cmd.CommandType = CommandType.Text;
					cmd.Parameters.Add("valor", OracleType.VarChar, 1).Value = valor;
					cmd.Parameters.Add("entrada", OracleType.Number).Value = no_entrada;
        ...
        #region Gastos por comision 
        public double ObtieneGastosOperativo(int subApp, double monto, double monto_aprobado, double gastos_operativos)
        {
            double gastos = 0.0;
            switch (subApp)
            {
                ...
                case 32:
                    ...
                    break;
                case 33:
                    gastos = (monto * 0.01) + gastos_operativos;
                    if (gastos > 10000.00)
                    {
                        gastos = 10000.00;
                    }
