...
namespace Docsis_Application
{
    public partial class s_calcliquidacion_doc : Form
    {
        ...
        private void btnCarlcularLiq_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtLiqui = da.ObtenerValoresLiquidacion(0,int.Parse(txtCodigo_sub_aplicacion.Text), 0, int.Parse(txtEdad.Text), int.Parse(txtPlazo.Text), vl_toma_seguro, double.Parse(txtHonorarios_compra_venta.Text), double.Parse(txtMejoras_avaluo.Text),
                                double.Parse(txtMonto_solicitado.Text), double.Parse(txtCuota_nivelada.Text), double.Parse(txtCuota_aportacion.Text), double.Parse(txtCoopsalud.Text));
