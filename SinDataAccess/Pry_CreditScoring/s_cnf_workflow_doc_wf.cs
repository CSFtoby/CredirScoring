...
namespace Docsis_Application
{
    public partial class s_cnf_workflow_doc_wf : Form
    {
        ...
        private void p_llenar_list_docs_del_wf()
        {
            ...
            try
            {
                string vl_sql = @"Select dw.documento_id,descripcion,sigla_doc,persona_solicitud,tipo_exigencia,decode(tipo_exigencia,'R','Requeridos','O','Opcionales') desc_tipo_exigencia
        ...
        private void p_llenar_combo_sub_aplicaciones()
        {
            ...
            try
            {
                var dt = da.ObtenerSubAplicaciones("MCR", "1");
