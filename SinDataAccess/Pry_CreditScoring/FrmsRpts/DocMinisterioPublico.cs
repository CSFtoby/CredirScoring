...
namespace Docsis_Application.FrmsRpts
{
	public partial class DocMinisterioPublico : Form
	{
		...
		public DocMinisterioPublico(int no_solicitud, DataAccess _da, int agencia)
		{
			InitializeComponent();
			this.da = _da;
		...
		private void GenerarDocumento()
		{
			try
			{
				...
				ReportParameter pa_anio = new ReportParameter("pa_anio", DateTime.Today.Year.ToString());
