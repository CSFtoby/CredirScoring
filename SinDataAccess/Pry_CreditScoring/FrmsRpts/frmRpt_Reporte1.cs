...
namespace Docsis_Application.FrmsRpts
{
    public partial class frmRpt_Reporte1 : Form
    {
        ...
        private void exportExcel()
        {
			...
			CheckForIllegalCrossThreadCalls = false;
			var datatable = da.p_datos_reporte1(dpFecha1.Value, dpFecha2.Value, sregional, sfilial, sestado, txtNo_solicitud.Text);
        ...
        private void copiarData()
        {
            ...
            gvReporte1.DataSource = da.p_datos_reporte1(dpFecha1.Value, dpFecha2.Value, sregional, sfilial, sestado, txtNo_solicitud.Text);
