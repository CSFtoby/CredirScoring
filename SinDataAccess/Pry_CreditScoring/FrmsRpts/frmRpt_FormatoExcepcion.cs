	...
	public partial class frmRpt_FormatoExcepcion : Form
	{
		...
		private void mostrar_reporte()
		{
			try
			{
                ...
                DateTime fecha_ingreso = Convert.ToDateTime(infoExcep.Rows[0]["fecha_ingreso_laboral"].ToString());
                ReportParameter pa_fecha_ingreso_laboral = new ReportParameter("fecha_ingreso_laboral", fecha_ingreso.ToString("MM/dd/yyyy"));
